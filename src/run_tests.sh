...
function all {
    ...
    test ./gb_emu ../tests/mooneye/acceptance/timer/tim00.gb > /dev/null
    test ./gb_emu ../tests/mooneye/acceptance/timer/tim00_div_trigger.gb > /dev/null
    test ./gb_emu ../tests/mooneye/acceptance/timer/tim01.gb > /dev/null
    test ./gb_emu ../tests/mooneye/acceptance/timer/tim01_div_trigger.gb > /dev/null
    test ./gb_emu ../tests/mooneye/acceptance/timer/tim10.gb > /dev/null
    test ./gb_emu ../tests/mooneye/acceptance/timer/tim10_div_trigger.gb > /dev/null
    test ./gb_emu ../tests/mooneye/acceptance/timer/tim11.gb > /dev/null
    test ./gb_emu ../tests/mooneye/acceptance/timer/tim11_div_trigger.gb > /dev/null
    test ./gb_emu ../tests/mooneye/acceptance/timer/tima_reload.gb > /dev/null
    test ./gb_emu ../tests/mooneye/acceptance/timer/tima_write_reloading.gb > /dev/null
...
function timer {
    ...
    test ./gb_emu ../tests/mooneye/acceptance/timer/timer_tima_write_reloading.gb > /dev/null
    test ./gb_emu ../tests/mooneye/acceptance/timer/timer_tma_write_reloading.gb > /dev/null
    test ./gb_emu ../tests/mooneye/acceptance/timer/tma_write_reloading.gb > /dev/null
    test ./gb_emu ../tests/mooneye/acceptance/timer/tim00.gb > /dev/null
    test ./gb_emu ../tests/mooneye/acceptance/timer/tim00_div_trigger.gb > /dev/null
    test ./gb_emu ../tests/mooneye/acceptance/timer/tim01.gb > /dev/null
    test ./gb_emu ../tests/mooneye/acceptance/timer/tim01_div_trigger.gb > /dev/null
